...
[Space Observation Template (PDF)](https://learningspacetoolkit.org/wp-content/uploads/observation-template.pdf)
– Dieses Dokument kann zur Erfassung von Beobachtungsdaten in Räumen
verwendet werden. Kann so wie es ist verwendet werden oder als
